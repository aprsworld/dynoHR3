...
#define	DYNO_RPM_DWELL	1	/* seconds to dwell at a given RPM */
...
int main(int argc, char **argv) {
	...
	fprintf(stderr,"# dynoHR3 start-up\n");
	...
	snprintf(clientid, 23, "dynoHR3_%d", getpid());
