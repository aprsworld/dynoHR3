...
set ylabel "Field DC Power (watts)" 
...
set title "Turbine Field DC Power versus RPM"
if ( exist("t") ) set title sprintf("Turbine Field DC Power versus RPM\n{/=20 %s}",t);
	
# do the plot
# flip the sign on the current
plot f using 3:($20 * $27 * -1.0) with linespoints 
