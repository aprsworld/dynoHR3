...
set xlabel "Turbine Speed (RPM)" 
set xlabel  font "" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ 50.0000 : 325.000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Rectifier DC Output Power (watts)" 
...
set title "Turbine DC Output Power versus RPM"
if ( exist("t") ) set title sprintf("Turbine Rectifier DC Output Power versus RPM\n{/=20 %s}",t);
	
# do the plot
# flip the sign on the current
plot f using 3:($6 * $13 * -1.0) with linespoints 
