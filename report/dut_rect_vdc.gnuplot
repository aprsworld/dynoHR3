...
set ylabel "Rectifier DC Output Voltage (VDC)" 
...
set title "Turbine DC Output Voltage versus RPM"
if ( exist("t") ) set title sprintf("Turbine Rectifier DC Output Voltage versus RPM\n{/=20 %s}",t);
	
# do the plot
plot f using 3:6 with linespoints 
